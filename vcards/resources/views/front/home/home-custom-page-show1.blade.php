...
<head>
    ...
    @if ($customPage['seo_description'])
        <meta name="description" content="{{ $customPage['seo_description'] }}">
    @endif
    @if ($customPage['seo_keyword'])
        <meta name="keywords" content="{{ $customPage['seo_keyword'] }}">
    @endif
...
<body>
    ...
    <header class="header bg-primary" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
        <div class="container">
    ...
    <section class="about-section overflow-hidden pt-100 pb-5" id=""
        @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
        <div class="container p-5 pt-60">
            <div class="row pt-3  justify-content-center">
                <div class="col-lg-8 margin-b-80px align-items-center">
                    <div class="mt-4 mt-lg-0">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="article-content mt-100px w-100 ql-editor">
