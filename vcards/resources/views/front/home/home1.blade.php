    ...
    @if(isset($setting['whatsapp_widget_show']) && $setting['whatsapp_widget_show'] == 1)
            ...
            <div id="whatsappModal" class="whatsapp-modal">
                <div class="whatsapp-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center overflow-hidden">
                        <div class="bg-white rounded-circle d-flex align-items-center justify-content-center p-1 me-2 flex-shrink-0" style="width: 40px; height: 40px;">
                            <img src="{{ getLogoUrl() }}" alt="Logo" class="img-fluid" style="max-height: 32px; object-fit: contain;">
                        </div>
                        <div class="text-white" style="min-width: 0;">
                            <h6 class="fw-bold mb-0 text-white" style="display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">{{ getAppName() }}</h6>
                        </div>
                    </div>
                    <button id="closeWhatsapp" type="button" class="btn btn-link text-white p-0 border-0 shadow-none">
                        <i class="fa-solid fa-xmark fs-2"></i>
                    </button>
                </div>

                <div class="p-4">
                    <div class="whatsapp-message mb-4">
                        <div class="quill-content text-dark">
                            <p class="mb-0">{{ __('messages.front_cms.hi_there') }} 👋</p>
                            <p class="mb-0">{{ __('messages.front_cms.how_can_help_you') }}</p>
                        </div>
                    </div>

                    <a href="https://wa.me/{{ $whatsappNumber }}?text={{ $whatsappMessage }}"
                       target="_blank"
                       class="whatsapp-chat-btn d-flex align-items-center justify-content-center gap-2">
                        <i class="fa-brands fa-whatsapp fs-4 text-white"></i>
                        <span class="text-white">{{__('messages.front_cms.chat_on_whatsapp')}}</span>
                    </a>
                </div>
            </div>

            <!-- Sticky Button -->
            <button id="toggleWhatsapp" type="button" class="whatsapp-sticky-btn">
        ...
        <script>
            $(document).ready(function() {
                $('#toggleWhatsapp').on('click', function() {
                    $('#whatsappModal').fadeToggle(300);
                });
                $('#closeWhatsapp').on('click', function() {
