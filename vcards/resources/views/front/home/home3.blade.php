    ...
    @if(isset($setting['whatsapp_widget_show']) && $setting['whatsapp_widget_show'] == 1)
        <div x-data="{ open: false }" class="fixed bottom-6 right-6 z-[999999]">
            <div x-show="open" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="bg-[#075E54] p-[1.3rem] flex items-center justify-between">
                ...
                <div class="p-6 pt-8">
                    <div class="bg-white p-3 rounded-2xl rounded-tl-none shadow-sm relative mb-8">
                    ...
                    <a href="https://wa.me/{{ $whatsappNumber }}?text={{ urlencode($whatsappMessage) }}" target="_blank"
                        ...
                        <i class="bx bxl-whatsapp text-xl sm:text-2xl shrink-0"></i>
