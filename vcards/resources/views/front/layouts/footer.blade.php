            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    ...
                    @if(isset($customPageAll) && $customPageAll && count($customPageAll) > 0)
                        <div class="pt-3 mb-3">
                            <div class="d-flex flex-wrap justify-content-center gap-1" style="gap: 0.25rem !important;">
...
<!-- start footer section -->
@if (checkFrontLanguageSession() != 'ar' && checkFrontLanguageSession() != 'fa')
    <footer class="pt-4 pb-4 bg-light" @if (checkFrontLanguageSession() == 'ar' || checkFrontLanguageSession() != 'fa') dir="rtl" @endif>
            ...
            <div class="row text-center mb-sm-auto mb-0 text-gray-300 fw-5 overflow-hidden">
                ...
                <div class="col-6">
                    <a href="{{ route('business.directory') }}"
                        class="text-decoration-none link-info fs-6">{{ __('messages.business_directory') }}</a>
        ...
        <div class="container text-center">
            <div class="row text-center mb-sm-auto mb-0 text-gray-300 fw-5 overflow-hidden">
                <div class="col-6"> © {{ \Carbon\Carbon::now()->year }} {{ __('auth.copyright_by') . ' ' }}<span
                        class="text-blue">{{ $setting['app_name'] }}</span></div>
                <div class="col-6">
                    <a href="{{ route('business.directory') }}" target="_blank"
                        class="text-decoration-none link-info fs-6">{{ __('messages.business_directory') }}</a>
                    <span class="slash">|</span>
                    <a href="{{ route('terms.conditions') }}" target="_blank"
                        class="text-decoration-none link-info fs-6">{!! __('messages.vcard.term_condition') !!}</a>
