        ...
        <footer class="bg-light">
            @if (isset($setting['mobile_app_enable']) && $setting['mobile_app_enable'] == 1)
                <div class="container">
                    ...
                    @if(isset($customPageAll) && $customPageAll && count($customPageAll) > 0)
                        <div class="custom-pages-section py-3 pt-sm-4 pt-md-3">
                            <div class="row g-2">
                                @foreach($customPageAll as $page)
                                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                                        <a href="{{ route('fornt-custom-page-show', $page->slug) }}"
                                        class="d-block text-dark text-decoration-none py-2 px-1">
                                            {{ $page->title }}
                                        </a>
                                    </div>
                                @endforeach
                    ...
                    {{-- Legal Links Section - Separate Row --}}
            ...
            @else
                <div class="container">
                    ...
                    @if(isset($customPageAll) && $customPageAll && count($customPageAll) > 0)
                        <div class="custom-pages-section py-3">
                            <div class="row g-2">
                                @foreach($customPageAll as $page)
                                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                                        <a href="{{ route('fornt-custom-page-show', $page->slug) }}"
                        ...
                        <div class="custom-pages-section py-3">
                            <div class="row g-2">
                                @foreach($customPageAll as $page)
                                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2">
                                        <a href="{{ route('fornt-custom-page-show', $page->slug) }}"
                                        class="d-block text-dark text-decoration-none py-2 px-1 text-end">
                                            {{ $page->title }}
                                        </a>
                                    </div>
                                @endforeach
                    ...
                    <div class="footer-bottom border-top border-light">
                        <div class="row align-items-center py-3">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="d-flex justify-content-md-end justify-content-center flex-wrap">
                                    <a href="{{ route('business.directory') }}"
                                        class="text-black text-decoration-none ms-3">{{ __('messages.business_directory') }}</a>
                                    <a href="{{ route('terms.conditions') }}"
