...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            <form data-turbo="false" name="e_card_form" action="{{ route('download.ecard') }}" method="post"
                                        ...
                                        <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                            ...
                                            <label>
                                                ...
                                                <input type="file" id="e-card-logo" name="ecard-logo"
                                                    class="image-upload file-validation d-none crop-image-input" accept="image/*" data-preview-id="createVirtualBackgroundPreview" />
                                            </label>
                                        </span>
                                    </div>
                                </div>
