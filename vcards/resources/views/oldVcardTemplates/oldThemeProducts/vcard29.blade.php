    ...
    <div class="container p-0">
        <div class="vcard-twentynine main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="row m-0 justify-content-between mx-0 align-items-center mb-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-6 px-2 text-start">
                        <h4 class="product-heading text-white mb-0">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    ...
                    @foreach ($vcard->products as $product)
                        <div class="px-2">
                            <div class="product-card card mb-10">
                                ...
                                <div class="card-body p-5 d-flex flex-column w-100 align-items-center gap-3">
