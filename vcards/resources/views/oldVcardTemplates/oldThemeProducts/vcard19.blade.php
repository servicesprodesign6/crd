    ...
    <div class="container p-0">
        <div class="vcard-nineteen bg-light main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="row justify-content-between mb-5 mx-0 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                        ...
                        @foreach ($products as $product)
                            <div class="mb-2 mt-1">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card px-2 border-0 h-100 mx-auto">
                                        ...
                                        <div class="d-flex flex-column gap-3 w-100 pt-0 p-5 align-items-center">
                                            <h4 class="mb-3">{{ $product->name }}</h4>
                                            <p class="text-dark mb-3">
                                                {{ $product->description }}
                                            </p>
                                            <div class="product-text text-center fs-20 fw-5">
