    ...
    <div class="container p-0">
        <div class="vcard-twentyseven bg-light main-content w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="row justify-content-between mx-0 align-items-center mb-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    ...
                    @foreach ($vcard->products as $product)
                        <div class="px-2">
                            <div class="product-card card mb-10">
                                ...
                                <div class="card-body p-5 d-flex justify-content-between align-items-center gap-4 flex-column gap-4">
