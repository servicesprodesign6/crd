    ...
    <div class="container p-0 product-details-page">
        <div class="vcard-eighteen bg-light main-content mx-auto w-100 overflow-hidden border">
            ...
            <div class="vcard-one__product py-3 mb-10 mt-0">
                <div class="row justify-content-between mb-3 mx-0 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4 px-2">
                        <h4 class="vcard-prodcut-heading text-start mb-0 text-primary">
                            {{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 px-2 text-center">
                        <div class="d-flex justify-content-end">
                            <a class="vcard-eighteen-btn rounded-2 btn-primary text-decoration-none"
                                href="{{ $vcardUrl }}"
                                        ...
                                        <div class="bg-primary-light card-body">
                                            <div class="d-flex justify-content-between"
                                                ...
                                                <div class="product-title">
                                                    <h3 class="text-primary fs-18 fw-5 mb-2">{{ $product->name }}</h3>
                                                </div>
                                            </div>
                                            <p class="text-dark mb-2">
                                                {{ $product->description }}</p>
                                            <div class="product-amount mb-2">
