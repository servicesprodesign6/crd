...
<body>
    <div class="container p-0 product-details-page h-100">
        <div class="vcard-fifteen bg-gray main-content mx-auto w-100 overflow-hidden">
            ...
            <div class="py-3 mb-10 mt-0 px-30">
                <div class="row mx-0 mb-5 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-9 px-0">
                        <h4 class="vcard-fifteen-heading mb-0">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-3 px-0 text-end" style="z-index: 1;">
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card p-2 border-0 h-100">
                                        ...
                                        <div class="product-desc p-5 pt-0 card-body text-center">
