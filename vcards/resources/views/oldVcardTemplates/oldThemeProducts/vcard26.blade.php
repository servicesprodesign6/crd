    ...
    <div class="container p-0">
        <div class="vcard-twentysix main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="row justify-content-between align-items-center mb-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4 px-2">
                        <h4 class="vcard-twentysix-heading mb-0 text-start">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    ...
                    @foreach ($vcard->products as $product)
                        <div class="products">
                            <div class="product-card card mb-10 pt-5">
                                ...
                                <div class="card-body card-padding p-5 pt-0 d-flex flex-column align-items-center gap-4 w-100">
