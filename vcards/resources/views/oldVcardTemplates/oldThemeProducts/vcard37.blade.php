    ...
    <div class="container p-0">
        <div class="vcard-thirtyseven main-content w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0">
                <div class="row justify-content-between px-30 mb-5 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-6 text-start">
                        <h4 class="product-heading mb-0">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 text-end">
                        <div class="d-flex justify-content-end">
                            <a class="back-btn text-decoration-none d-flex" href="{{ $vcardUrl }}"
                                role="button">{{ __('messages.common.back') }}</a>
                        </div>
                    </div>
                </div>
                <div class="product-slider px-30">
                    @foreach ($vcard->products as $product)
                        <div>
                            <div class="product-card card">
                                ...
                                <div class="card-body card-margin p-3 mt-5">
                                    ...
                                    <p class="fs-14 text-black mb-0 p-2">{{ $product->description }}</p>
