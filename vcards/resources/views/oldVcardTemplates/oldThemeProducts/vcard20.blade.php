            ...
            <div class="vcard-one__product py-3 mt-0 h-100 px-30">
                <div class="row justify-content-between align-items-center mb-5 mx-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4 px-2">
                        <h4 class="vcard-twenty-heading text-start">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 px-2">
                        <div class="d-flex justify-content-end">
                            <a class="vcard-twenty-btn text-decoration-none"
                                href="{{ $vcardUrl }}"
                    ...
                    <div class="product-slider">
                        @foreach ($vcard->products as $product)
                            <div class="px-2 product-box">
                                <div class="product-card card product-img-padding-20">
                                    <div
                                    ...
                                    <div class="card-body text-center p-0 d-flex flex-column w-100 gap-3">
