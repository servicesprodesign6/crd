                    ...
                    @foreach ($vcard->products as $product)
                        <div class="px-2">
                            <div class="product-card card mb-5">
                                ...
                                <div class=" card-body d-flex flex-column gap-3 w-100 align-items-center text-center px-3 pb-5">
                                    <div class="product-desc d-flex justify-content-between align-items-center mt-0"
