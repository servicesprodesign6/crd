...
<body>
    <div class="container p-0 product-details-page h-100">
        <div class="main-content mx-auto w-100 overflow-hidden border">
            ...
            <div class="vcard-one__product py-3 mb-10 mt-0 px-30">
                <div class="row justify-content-between align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4">
                        <h4 class="vcard-seventeen-heading mb-0" style="font-size:24px">
                            {{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 text-end">
                        <a class="vcard-seventeen-btn text-decoration-none d-block ms-auto"
                            href="{{ $vcardUrl }}"
                        ...
                        @foreach ($products as $product)
                            <div class="d-flex justify-content-center mb-2">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card border h-100">
                                        ...
                                        <div class="bg-primary-light card-body p-5 text-center">
                                            ...
                                            @if ($product->product_url)
                                                <div class="ms-1 mt-2">
                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        class="btn send-btn rounded-2 btn-primary btn-product-enquiry @if(!$product->product_url) disabled @endif">
