...
<body>
    <div class="container p-0 product-details-page">
        <div class="vcard-sixteen main-content  w-100 mx-auto content-blur allSection collapse show">
            ...
            <div class="vcard-one__product py-3 mb-10 pt-4 mt-0 px-30">
                <div class="row m-0  mb-5 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-sm-9">
                        <h4 class="vcard-sixteen-heading mb-0">{{ __('messages.vcard.products') }}</h4>
                    </div>
                            ...
                            <div class="d-flex justify-content-center mb-4">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card border-0 h-100">
                                        ...
                                        <div class="product-desc card-body d-flex align-items-center justify-content-between text-center p-2"
                                        ...
                                        <div class="product-amount text-primary text-center fs-18 mb-2">
