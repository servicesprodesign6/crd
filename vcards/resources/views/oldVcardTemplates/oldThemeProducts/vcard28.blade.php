    ...
    <div class="container p-0">
        <div class="vcard-twentyeight bg-light main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="row justify-content-between align-items-center mb-5 mx-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4 px-2">
                        <h4 class="product-heading mb-0 text-start">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 text-center px-2">
                        <div class="d-flex justify-content-end">
                            <a class="back-btn text-decoration-none"
                                href="{{ $vcardUrl }}"
                    ...
                    @foreach ($vcard->products as $product)
                        <div class="px-2">
                            <div class="product-card card mb-10">
                                ...
                                <div class="card-body p-5 d-flex justify-content-between align-items-center w-100 flex-column gap-4">
                                    ...
                                    <p class="fs-14 text-dark mb-0 p-0">{{ $product->description }}</p>
                                    <div class="product-amount text-primary fw-bold fs-18">
                                            @if ($product->currency_id && $product->price)
                                                <span
                                                    class="fs-18 fw-6 text-purple  product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
