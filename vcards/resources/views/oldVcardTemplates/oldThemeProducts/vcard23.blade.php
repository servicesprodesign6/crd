            ...
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="row justify-content-between mx-0 mb-5 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4 px-2">
                        <h4 class="product-head mb-0 text-start">{{ __('messages.vcard.products') }}</h4>
                    </div>
                        ...
                        @foreach ($vcard->products as $product)
                            <div class="">
                                <div class="product-card card mb-10">
                                    ...
                                    <div class="card-body pt-0 p-5 text-center d-flex justify-content-between align-items-center gap-4 flex-column">
