    ...
    <div class="container p-0">
        <div class="vcard-thirtyfive main-content w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="d-flex justify-content-between mx-0 mb-5 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="px-2">
                        <h4 class="product-heading text-start mb-0">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="px-2 text-center">
                            <a class="back-btn text-decoration-none text-dark d-block"
                                href="{{ $vcardUrl }}"
                    ...
                    @foreach ($vcard->products as $product)
                        <div class="px-2">
                            <div class="product-card card mb-3">
                                ...
                                <div class="card-body d-flex flex-column w-100 align-items-center gap-3 p-3">
                                    <div class="product-desc d-flex justify-content-between align-items-cente"
