    ...
    <div class="container p-0">
        <div class="vcard-thirtysix main-content bg-light  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="row justify-content-between align-items-center mx-0 mb-5" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                ...
                <div class="product-slider">
                    @foreach ($vcard->products as $product)
                        <div class="px-2">
                            <div class="product-card card  mb-4 pb-4">
                                ...
                                <div class="px-4 py-0 card-body d-flex justify-content-between align-items-center w-100 gap-3 flex-column">
                                    ...
                                    <p class="fs-14 text-dark mb-0">{{ $product->description }}</p>
                                     <div class="product-amount text-primary fw-bold fs-18">
                                            @if ($product->currency_id && $product->price)
                                                <span
                                                    class="fs-18 fw-6 text-success  product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                            @elseif($product->price)
                                                <span
                                                    class="fs-18 fw-6 text-success product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                            @endif
                                        </div>
