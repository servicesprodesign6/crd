            ...
            @foreach ($products as $product)
                <div class="col-lg-3 col-sm-6">
                    <div class="h-100 d-flex justify-content-between flex-column product-card bg-white">
                        ...
                        <button
                            class="@if($product->available_stock == 0) disabled @endif btn btn-primary d-flex gap-2 align-items-center fs-12 fw-6 addToCartBtn addToCartButton add-to-cart-min-w-127px justify-content-center mb-2"
                            data-id="{{ $product->id }}">
                        ...
                        @else
                            <span class="badge fs-14 bg-danger text-white out-of-stock-text d-flex justify-content-center align-items-center mb-2" style="height: 37px; margin-left: 13%;">
