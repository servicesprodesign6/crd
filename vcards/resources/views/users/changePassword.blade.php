<div class="modal fade" id="changeUserPasswordModal" tabindex="-1" aria-modal="true" role="dialog" >
    <div class="modal-dialog">
        <div class="modal-content"  @if(getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') dir="rtl" @endif>
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <span class="position-absolute d-flex align-items-center top-0 bottom-0 @if(getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa')
                            start-0 ms-4
                        @else
                            end-0 me-4
                        @endif input-icon input-password-hide cursor-pointer text-gray-600">
            ...
            <div class="modal-footer pt-0 @if(getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') gap-3 @endif">
