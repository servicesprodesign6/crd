        ...
        <div class="d-flex flex-column">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 widget mb-3">
                                <div
                                    class="bg-info shadow-md rounded-10 p-xxl-10 p-5 px-md-7 py-md-10 d-flex align-items-center
                            ...
                            <div class="col-md-6 widget mb-3">
                                <div
                                    class="bg-success shadow-md rounded-10 p-xxl-10 p-5 px-md-7 py-md-10 d-flex align-items-center justify-content-between h-100">
                                    <div class="d-flex align-items-center justify-content-center">
