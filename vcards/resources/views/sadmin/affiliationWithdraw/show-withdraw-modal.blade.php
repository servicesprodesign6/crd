<div class="modal fade" id="showAffiliationWithdrawModal" tabindex="-1" aria-labelledby="showAffiliationWithdrawModal"
    aria-hidden="true" @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') style="direction: rtl;" @endif>
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close @if (getLogInUser()->language == 'ar' || getLogInUser()->language == 'fa') ms-0 @endif"
