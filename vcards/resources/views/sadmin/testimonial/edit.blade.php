            ...
            <div class="modal-body">
                ...
                <div class="mb-3" io-image-input="true">
                    ...
                    <label>
                        ...
                        <input type="file" id="editTestimonialImg" name="image" class="image-upload file-validation d-none crop-image-input"
                               accept="image/*" data-crop-width="110" data-crop-height="110" data-preview-id="editFrontTestimonialImagePreview"/>
                    </label>
                </span>
                        </div>
