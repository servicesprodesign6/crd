...
@elseif ($component->isBootstrap())
    <div class="d-flex justify-content-between align-items-center mb-sm-7 mb-4 flex-wrap custom-domain-header">
        ...
        <div class="d-block d-md-flex justify-content-end align-items-center pt-0 mt-0">
            <div class="d-flex justify-content-end align-items-end flex-wrap gap-3 steps-download">
