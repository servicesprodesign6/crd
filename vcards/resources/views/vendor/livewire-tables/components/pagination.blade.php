...
@elseif ($component->isBootstrap5())
    <div>
        <div class="d-flex align-items-center flex-wrap flex-md-nowrap gap-2 mb-5 mt-3">
            @if ($component->paginationVisibilityIsEnabled())
                @if ($component->paginationIsEnabled() && $component->perPageVisibilityIsEnabled())
                    ...
                    @if ($component->paginationIsEnabled() && $rows->lastPage() > 1)
                        <div class="row flex-lg-row-reverse flex-column-reverse mx-0 w-100">
                            <div class="col-12 col-xxl-9 col-lg-8 overflow-auto pagination-center ms-auto">
                                {{ $rows->links('livewire-tables::specific.bootstrap-4.pagination') }}
                            </div>
                            <div
                                class="col-12 col-xxl-3 col-lg-4 text-gray-600 d-flex align-items-center justify-content-sm-start justify-content-center mb-md-0 mb-3 flex-wrap ps-0">
                                <div class="fs-4 fs-xl-6">
                                    <span>@lang('Showing')</span>
                    ...
                    @else
                        <div class="row">
                            <div class="col-12 text-gray-600 fs-4">
                                @lang('Showing')
                                <strong>{{ $rows->count() }}</strong>
                                @lang('results')
                            </div>
