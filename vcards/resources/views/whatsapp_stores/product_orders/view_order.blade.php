        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-5 order-type-div">
                        <label class="form-label fs-6 text-gray-700">
                            {{ __('messages.whatsapp_stores.order_type') . ':' }}
                        </label>
                        <p id="orderType" class="text-gray-600 fw-bold mb-0"></p>
                    </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            ...
                            <tr class="delivery-charge-row">
                                <td colspan="4" class="text-end">{{ __('messages.whatsapp_stores.delivery_charge') }}:</td>
                                <td id="orderFooterDeliveryCharge" class="fw-bold"></td>
                            </tr>
                            <tr>
