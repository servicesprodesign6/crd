    ...
    <div class="dropdown d-flex align-items-center me-4 me-md-5" wire:ignore>
        ...
        <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuProductOrderStatus">
            ...
            <div class="p-5">
                ...
                <div class="mb-5">
                    <label for="exampleInputSelect2" class="form-label">{{ __('messages.whatsapp_stores.order_type') }}</label>
                    {{ Form::select('order_type', getTranslatedData($orderType), null, ['class' => 'form-control form-select', 'data-control' => 'select2', 'id' => 'productOrderType', 'wire:ignore']) }}
                </div>
