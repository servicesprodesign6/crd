                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-5">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control product-sort" name="sort" id="editProductSort"
                                            ...
                                            <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                ...
                                                <label>
                                                    ...
                                                    <input type="file" id="editProductIcon" name="images[]"
                                                        class="image-upload file-validation d-none crop-image-input" data-crop-width="280" data-crop-height="230" accept="image/*" data-preview-id="editWpStoreProductPreview"
                                                        multiple />
                                                </label>
                                            </span>
                                        </div>
