            ...
            <div class="modal-body">
                <form id="whatsappStoreProductForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-5">
                            <div class="form-group">
                                <label class="form-label">{{ __('messages.common.sort') . ':' }}</label>
                                <input type="number" class="form-control product-sort" name="sort"
                                    placeholder="{{ __('messages.common.sort') }}">
                            </div>
                        </div>
                        <div class="col-md-12 mt-5">
                            <div class="form-group">
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-2">
                                    <label for="description" class="form-label required mb-0">
                                        {{ __('messages.vcard.description') }}:
                                    </label>
                                    <button type="button" class="btn btn-sm text-primary wp-store-ai-description-btn">
                                            ...
                                            <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                ...
                                                <label>
                                                    ...
                                                    <input type="file"  name="images[]"
                                                        class="image-upload file-validation d-none crop-image-input" data-crop-width="280" data-crop-height="230" accept="image/*" data-preview-id="createWpStoreProductPreview"
                                                        multiple />
                                                </label>
                                            </span>
                                        </div>
