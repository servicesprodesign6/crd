                            ...
                            <div class="details d-flex flex-column justify-content-between h-100">
                                <div>
                                    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                        <h4 class="fs-28 fw-6 mb-0 product-name">{{ $product->name }}</h4>
                            ...
                            <a href="{{ route('whatsapp.store.product.details', [$whatsappStore->url_alias, $product->id]) }}"
                                ...
                                <div class="d-flex flex-column gap-2 justify-content-between">
                                    <div>
                                        ...
                                        @else
                                            <span class="bg-danger text-white d-flex p-2 justify-content-center align-items-center mx-auto gap-2 out-of-stock-text" style="border-radius: 10px;">
                                                {{ __('messages.whatsapp_stores.out_of_stock') }}
                                            </span>
                                        @endif
                                    </div>
