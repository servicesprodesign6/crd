                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 product-box-section bg-white">
                                <div class="h-100 flex-column justify-content-between d-flex">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        @else
                                            <button style="margin-left: 0%; height: 40px;" class="btn btn-danger text-danger d-flex justify-content-center align-items-center w-50 fs-14 gap-2 fw-5 out-of-stock-text">
