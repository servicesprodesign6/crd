                        ...
                        <div class="table-details d-flex flex-column h-100 justify-content-between">
                            ...
                            <div class="mb-15">
                                ...
                                <div id="deliveryChargeSection" class="d-none">
                                    ...
                                    <p class="fs-18 text-black text-end fw-5 mb-0 pt-3">+ {{ __('messages.whatsapp_stores.delivery_charge') }} : <span id="deliveryChargeText">0</span> </p>
                                </div>
                                ...
                                @if ($whatsappStore->take_away || $whatsappStore->delivery)
                                    <h3 class="fs-18 fw-5 text-black mb-3">{{ __('messages.whatsapp_stores.fulfillment_method') }}</h3>
