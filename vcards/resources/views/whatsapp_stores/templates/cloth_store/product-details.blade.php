                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="details d-flex flex-column justify-content-between h-100">
                            ...
                            @if ($product->available_stock != 0)
                                <button
                                    class="btn btn-primary d-flex justify-content-center align-items-center w-100 fs-18 gap-2 fw-5 addToCartBtn"
                                    data-id="{{ $product->id }}">
                                    <span>
                            ...
                            @else
                                <button class="btn btn-danger text-danger d-flex justify-content-center align-items-center w-50 fs-18 gap-2 fw-5 out-of-stock-text">
                            ...
                            <div class=" h-100 d-flex flex-column">
                                ...
                                <div class="product-desc h-100">
                                    ...
                                    <div class="d-flex flex-column gap-2 justify-content-between">
                                        ...
                                        @if ($product->available_stock > 0)
                                            <button
                                                class="@if($product->available_stock == 0) disabled @endif mt-2 btn btn-primary d-flex gap-2 align-items-center fs-12 fw-6 w-75 justify-content-center addToCartBtn add-to-cart-min-w-127px ms-4"
                                        ...
                                        @else
                                           <button style="margin-left: 13%; height: 36px;" class="mt-2 btn btn-danger text-danger mx-auto d-flex justify-content-center align-items-center w-75 fs-14 gap-2 fw-5 out-of-stock-text">
                                                {{ __('messages.whatsapp_stores.out_of_stock') }}
                                            </button>
                                        @endif
                                </div>
