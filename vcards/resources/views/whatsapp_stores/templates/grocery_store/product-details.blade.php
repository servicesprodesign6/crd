                            ...
                            <div class="details d-flex flex-column justify-content-between h-100">
                                <div>
                                    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                        <h4 class="fs-24 fw-6 mb-0 product-name">{{ $product->name }}</h4>
                                        <a href="https://api.whatsapp.com/send?text={{ urlencode($product->name . ' - ' . url()->current()) }}"
                                            target="_blank" class="product-share-btn fs-14">
                                    ...
                                    <div class="product-details">
                                        ...
                                        @else
                                            <button style="margin-left: 13%;"
                                                class="btn btn-danger text-danger d-flex justify-content-center align-items-center w-75 fs-18 gap-2 fw-5 out-of-stock-text mx-auto">
                                                {{ __('messages.whatsapp_stores.out_of_stock') }}
                                            </button>
                                        @endif
                                    </div>
