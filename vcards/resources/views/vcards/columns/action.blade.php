<div class="action-btn option d-flex align-items-center text-center gap-3">
    @if (analyticsFeature())
    <a href="{{ route('vcard.analytics', $row->id)}}" class="text-primary" >
        <i class="fa-solid fa-chart-line fs-2"></i>
    </a>
    @endif
    <a href="{{ route('vcard.showSubscribers', $row->id)}}" class="text-primary" >
        <h3 class="d-flex align-items-center justify-content-center mb-0"><i class="fa-solid fa-users"></i></h3>
     </a>

    <a href="{{ route('vcard.showContact', $row->id) }}" class="text-primary" >
        <h3 class="d-flex align-items-center justify-content-center mb-0"><i class="fa-solid fa-phone"></i></h3>
    </a>
            ...
            @if (getLogInUser()->organisation_id == null)
                <li>
                    <a href="javascript:void(0)" data-id="{{ $row->id }}" title="{{ __('messages.common.delete') }}"
                        ...
                        <i class="fa-solid fa-trash-can fs-4 me-2"></i>&nbsp;{{ __('messages.common.delete') }}
                    </a>
                </li>
            @endif
        </ul>
