...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    ...
    <div class="d-flex justify-content-center align-items-center {{ (isset($dynamicVcard) && $dynamicVcard->sticky_bar == 0) ? 'dynamic-sticky-left' : 'dynamic-sticky-right' }}" id="sticky-dynamic-btn">
        <svg class="sticky_icon" height="20" width="20" viewBox="0 0 25 25" fill="none"
    ...
    <div class="container p-0 vcard22-main position-relative">
      ...
      <div class="main-content mx-auto w-100  bg-green">
            ...
            <div class="language pt-3">
                <ul class="text-decoration-none ps-0">
                    <li class="dropdown1 dropdown">
                        <a href="#" id="select-language-btn" class= "dropdown-toggle lang-head text-decoration-none">
                                    EN
                        </a>
                    </li>
                </ul>
        ...
        <div class="profile-section pt-40 px-25 position-relative">
          ...
          <div
            class="card d-flex flex-column flex-sm-row gap-3 gap-sm-4 align-items-center position-relative"
          >
            <div class="card-img">
              <img
            ...
            <div class="card-body p-0 text-center text-sm-start">
              <div class="profile-name">
                <h2 class="text-primary mb-0 fs-16">Pallavi Hegde</h2>
                <p class="mb-0 text-white fs-16">UI / UX Designer</p>
              </div>
            </div>
          </div>
          <p
            class="text-gray-100 profile-desc mb-0 pt-40 fs-14 text-sm-start text-center"
          >
          ...
          <div class="social-media-section pt-40">
        ...
        <div class="contact-section pt-40 px-25 position-relative">
        ...
        <div class="our-services-section px-25 pt-40">
          <div class="section-heading text-center">
        ...
        <div class="appointment-section pt-40 px-25">
          <div class="section-heading text-center">
          ...
          <div class="appointment">
            ...
            <div class="">
                <div class="row row-gap-20px mb-5">
                    <div class="col-sm-6 appointment-slot-width">
                        <div class="hour-input w-100 d-flex justify-content-center align-items-center button-style"  id="appointment-slot1" data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}">
                            <span class="fw-5">8:10 - 20:00</span>
                        </div>
                    </div>
                    <div class="col-sm-6 appointment-slot-width">
                        <div class="hour-input w-100 d-flex justify-content-center align-items-center button-style"  id="appointment-slot2" data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}">
                            <span class="fw-5">8:10 - 20:00</span>
                        </div>
                    </div>
                    <div class="col-sm-6 appointment-slot-width">
                        <div class="hour-input w-100 d-flex justify-content-center align-items-center button-style" id="appointment-slot3" data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}">
                            <span class="fw-5">8:10 - 20:00</span>
                        </div>
                    </div>
                    <div class="col-sm-6 appointment-slot-width">
                        <div class="hour-input w-100 d-flex justify-content-center align-items-center button-style" id="appointment-slot4" data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}">
                            <span class="fw-5">8:10 - 20:00</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="gallery-section pt-40 px-25">
          <div class="section-heading px-25 text-center">
        ...
        <div class="product-section pt-40 px-3">
          <div class="section-heading text-center">
              ...
              <div class="product-card card position-relative">
                ...
                <div class="product-desc card-body p-0 text-center">
                  <div
                    class="mb-2"
                  >
                    <h3 class="fs-16 fw-5 mb-0 product-head">Lorem Ipsum</h3>
                  </div>
          ...
          <div class="mt-4 text-center view-more">
            <a class="fs-6 text  btn-primary btn text-decoration-none"
                href="#" data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}" class= "dropdown-toggle lang-head text-decoration-none" style="padding: 10px 20px">View More
                <i class="fa-solid fa-arrow-right-long right-arrow-animation"></i>
            </a>
        </div>
        </div>
        <div class="testimonial-section pt-40 px-3">
          <div class="section-heading px-3 text-center">
                    ...
                    <div class="d-flex justify-content-between align-items-end">
                      <div class="d-flex flex-wrap align-items-center">
                        <div class="testimonial-profile-img mt-3">
                          <img
                            src="{{ asset('assets/img/vcard22/testimonial-profile-img.png') }}"
                            class="w-100 h-100 bject-fit-contain"
                          />
                        </div>
                        <div class="profile-desc mt-3">
                          <h3 class="text-primary fs-18 mb-1">James Brown</h3>
        ...
        <div class="blog-section pt-40 px-3">
          <div class="section-heading px-3 text-center">
        ...
        <div class="business-hour-section pt-40 pb-40 px-25 position-relative">
            <div class="rotate-vector">
                <div class="position-absolute vcard22-bg-hero-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 221 97" fill="currentColor">
            <path d="M0.5 0.5C73.1 0.5 145.7 0.5 220.5 0.5C220.5 29.5688 220.5 58.6376 220.5 88.5873C205.006 96.3086 202.782 98.6149 193.923 94.4598C187.293 91.3503 186.589 86.0967 181.323 80.4878C180.874 80.0094 180.466 79.4875 180.009 79.0168C178.401 77.3622 175.619 76.2059 174.177 75.6852C173.566 75.4642 172.926 75.3433 172.277 75.2969C170.707 75.1847 167.438 75.0005 163.931 75.099C165.62 75.0892 162.292 75.1084 163.931 75.099C159.223 75.3355 149.842 76.0658 145.198 76.8424C129.011 77.958 127.021 79.2055 120.549 76.8565C119.269 76.3918 118.115 75.6188 117.22 74.5918C112.091 68.703 108.795 61.1543 104.871 54.442C104.262 53.4163 103.653 52.3905 103.025 51.3337C102.506 50.414 101.986 49.4942 101.451 48.5466C97.7653 43.9322 93.6962 41.9035 87.914 40.8676C77.5861 40.6639 72.2134 42.2386 64.0245 48.4262C61.4402 50.1476 61.0913 50.3799 57.5201 51.0646C56.2498 51.3081 54.9353 51.3077 53.6822 50.9871C48.8572 49.7529 45.6281 47.8384 42.4612 43.8767C42.0413 43.3515 41.6966 42.7696 41.4151 42.1589C39.5222 38.0526 37.8738 33.8877 36.2189 29.6732C31.1798 17.5989 21.9646 13.4603 10.8356 7.84061C8.76622 6.69317 6.70367 5.5334 4.65268 4.35382C3.2823 3.56654 1.91191 2.77926 0.5 1.96812C0.5 1.48364 0.5 0.999162 0.5 0.5Z" />
        ...
        <div class="rotate-vector-bottom">
          ...
          <div class="">
            <div class="business-hour-card row row-gap-20px justify-content-center">
              <div class="col-12">
                <div class="business-hour">
                       <div class="time-icons d-flex align-items-center justify-content-center">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-calendar-time text-light-100" width="24" height="24"
                  ...
                  <span >{{ __('messages.dynamic_vcard.sunday') }}:</span>
              ...
              <div class="col-12">
                <div class="business-hour">
                  ...
                  <span>{{ __('messages.dynamic_vcard.monday') }}:</span>
                  <span>08:10 - 20:00</span>
                </div>
              </div>
              <div class="col-12">
                <div class="business-hour">
                  ...
                  <span>{{ __('messages.dynamic_vcard.tuesday') }}:</span>
                  <span>08:10 - 20:00</span>
                </div>
              </div>
              <div class="col-12">
                <div class="business-hour">
                  ...
                  <span>{{ __('messages.dynamic_vcard.wednesday') }}:</span>
                  <span>08:10 - 20:00</span>
                </div>
              </div>
              <div class="col-12">
                <div class="business-hour">
                  ...
                  <span>{{ __('messages.dynamic_vcard.thursday') }}:</span>
                  <span>08:10 - 20:00</span>
                </div>
              </div>
              <div class="col-12">
                <div class="business-hour">
                  ...
                  <span>{{ __('messages.dynamic_vcard.friday') }}:</span>
                  <span>08:10 - 20:00</span>
                </div>
              </div>
              <div class="col-12">
                <div class="business-hour">
                  ...
                  <span>{{ __('messages.dynamic_vcard.saturday') }}:</span>
        ...
        <div class="qr-code-section pt-40 px-25">
          <div class="section-heading text-center">
            <h2 class="mb-0">{{ __('messages.dynamic_vcard.qr_code') }}</h2>
          </div>
          <div
            class="qr-code d-flex justify-content-center align-items-center position-relative"
          >
        ...
        <div class="qr-code-box flex-column flex-sm-row">
        ...
        <div class="contact-us-section pt-40 px-25">
            <div class="section-heading text-center">
        ...
        <div class="create-vcard-section pt-40 px-25 pb-40">
          <div class="section-heading text-center">
          ...
          <div class="">
            <div class="vcard-link-card card">
              <div class="d-flex align-items-center justify-content-center">
                ...
                >
                <i
                  class="icon fa-solid fa-arrow-up-right-from-square ms-3 text-black"
                ></i>
              </div>
            </div>
          </div>
        </div>
        <div class="add-to-contact-btn">
        <div class="text-center">
