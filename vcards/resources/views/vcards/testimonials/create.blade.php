                                    ...
                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                        ...
                                        <label>
                                            ...
                                            <input type="file" id="testimonialImg" name="image"
                                                   class="image-upload file-validation d-none crop-image-input" data-crop-width="100" data-crop-height="100" accept="image/*" data-preview-id="createTestimonialPreview"/> </label>
                                    </span>
                                </div>
