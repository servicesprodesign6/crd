                                    ...
                                    <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                                        ...
                                        <label>
                                            ...
                                            <input type="file" id="editTestimonialImg" name="image"
                                                   class="image-upload file-validation d-none crop-image-input" accept="image/*" data-crop-width="100" data-crop-height="100" data-preview-id="editTestimonialPreview"/> </label>
                                    </span>
                                </div>
