                ...
                <div class="row mb-5">
                    ...
                    <div class="mb-5 col-lg-12">
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-3">
                            {{ Form::label('description', __('messages.common.description') . ':', ['class' => 'form-label fs-6 text-gray-700 mb-0']) }}
                            <button type="button" class="btn btn-sm text-primary product-ai-description-btn"
                                data-form="#addProductForm" data-target="#productDescription">
                                <i class="fa-solid fa-wand-magic-sparkles me-1"></i>
                                {{ __('messages.vcard.generate_description_with_ai') }}
                            </button>
                        </div>
                        {{ Form::textarea('description', null, ['class' => 'form-control', 'id' => 'productDescription', 'placeholder' => __('messages.form.short_description'), 'rows' => '5']) }}
                    </div>
                    <div class="mb-5 col-lg-12">
