...
<body class="
    ...
    @elseif($blog->vcard->template_id == 66)
        vcard-forty-body
    @elseif($blog->vcard->template_id == 67)
        vcard-fortyone-body
    @elseif($blog->vcard->template_id == 68)
        vcard-fortytwo-body
    @endif">
...
@endif
@if ($blog->vcard->template_id == 65)
    <div class="vcard39-bg-effect">
        <div></div>
        <div></div>
        <div></div>
        <div></div>
...
@endif
    ...
    @elseif($blog->vcard->template_id == 66)
            vcard-forty-bg h-auto
    @elseif($blog->vcard->template_id == 67)
            vcard-fortyone-bg h-auto
    @elseif($blog->vcard->template_id == 68)
            vcard-fortytwo-bg h-auto
    @elseif($blog->vcard->template_id == 27)
            vcard-twentyseven-bg h-auto @endif">
            <div class="vcard-one-main-section p-3">
                <div class="d-flex justify-content-between align-items-center pb-3 gap-4 title-section" @if (getLanguage($blog->vcard) ==
...
@elseif($blog->vcard->template_id == 27)
                    ...
                    @elseif($blog->vcard->template_id == 66)
                            vcard-forty-back text-white
                    @elseif($blog->vcard->template_id == 67)
                            vcard-fortyone-back text-white
                    @elseif($blog->vcard->template_id == 68)
                            vcard-fortytwo-back text-white
                    @elseif($blog->vcard->template_id == 27)
