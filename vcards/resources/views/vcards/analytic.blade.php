                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex gap-4 align-items-center">
                           <div class="graph-icon d-flex justify-content-center align-items-center" id="changeChart">
                            ...
                            <div id="timeRange" class="time_range time_range_width btn dashboard-calendar-btn align-items-center d-flex gap-2">
