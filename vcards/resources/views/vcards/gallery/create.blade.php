                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 mt-3">
                        <div class="mb-3">
                            ...
                            {{ Form::select('category_id', $galleryCategories, null, ['class' => 'form-control form-select form-select-solid fw-bold', 'id' => 'galleryCategory', 'data-control' => 'select2', 'data-dropdown-parent' => '#addGalleryModal', 'placeholder' => __('messages.whatsapp_stores.select_category')]) }}
                        </div>
                    </div>
                                    ...
                                    <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                                        ...
                                        <label>
                                            ...
                                            <input type="file" id="addImage" name="image"
                                                   class="image-upload file-validation d-none crop-image-input" accept="image/*" data-preview-id="createGalleryPreview"/> </label>
                                    </span>
                                </div>
