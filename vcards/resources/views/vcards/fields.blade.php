                    ...
                    <div class="mt-5 row">
                        ...
                        <div class="col-lg-6 mb-7">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div id="dobIconPreview"
                                    class="border rounded d-flex align-items-center justify-content-center"
                                    style="width:50px; height:42px; cursor:pointer;"
                                    data-bs-toggle="modal" data-bs-target="#iconPickerModalV2">
                                    <i class="{{ (isset($vcard) && $vcard->dob_icon) ? $vcard->dob_icon : 'fa-solid fa-cake-candles' }}" style="color: {{ isset($vcard) && $vcard->dob_icon_color ? $vcard->dob_icon_color : '#1C274C' }}; height: 20px;"></i>
                                </div>

                                {{ Form::text('dob', isset($vcard) ? $vcard->dob : null, ['class' => 'form-control', 'placeholder' => __('messages.form.DOB')]) }}
                            </div>
                            <input type="hidden" name="dob_icon" id="dob_icon"
                                value="{{ isset($vcard) ? $vcard->dob_icon : '' }}">
                        </div>
        ...
        <div class="container-fluid pt-5">
            <div class="row g-3 pt-5" id="basic">
                @if (isset($vcard))
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card h-100 shadow p-5 text-center">
                            {{ Form::label('enable_business_directory', __('messages.display_business_directory') . ':', ['class' => 'form-label']) }}
                            <div
                                class="form-check form-switch form-check-custom form-check-solid form-switch-sm d-flex justify-content-center">
                                {{ Form::checkbox('enable_business_directory', 1, $vcard['enable_business_directory'] ?? 0, ['class' => 'form-check-input mt-2', 'id' => 'enableBusinessDirectory']) }}
                            </div>
                        </div>
                    </div>
                @endif
...
@if ($partName == 'templates')
    <div class="container-fluid">
        ...
        <div class="sticky-template-actions">
            <button class="btn btn-primary me-3 template-save">
                <i class="fas fa-save me-1"></i>
                {{ __('messages.common.save') }}
            </button>

            <a href="{{ route('vcards.index') }}" class="btn btn-secondary">
            ...
            <div class="col-12 col-sm-10 col-md-8 col-lg-6">
                <div class="card shadow rounded-3">
                    <div class="card-body">
                        ...
                        <div class="mb-4" io-image-input="true">
                            <label for="exampleInputImage"
                                class="form-label">{{ __('messages.plan.custom_qrcode') }}:</label>
                            <span data-bs-toggle="tooltip" data-placement="top"
                                data-bs-original-title="{{ __('messages.vcard.qrcode_img') }} {{ __('messages.vcard.qrcode_image_tooltip') }}">
                                <i class="fas fa-question-circle ml-1 general-question-mark"></i>
                            </span>
                            <div class="d-block">
                                <div class="image-picker">
                                    ...
                                    <div class="image previewImage" id="qrcodePreview"
                                        style="background-image: url('{{ $qrMedia ? $qrMedia->getUrl() : asset('assets/images/default_qrcode.png') }}')">
                                    </div>
                                    <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                        data-bs-toggle="tooltip" data-placement="top"
                                        ...
                                        <label>
                                            ...
                                            <input type="file" id="qrcode_image" name="qrcode_img"
                                                class="image-upload file-validation d-none crop-image-input" accept="image/*" data-preview-id="qrcodePreview" data-crop-width="200" data-crop-height="200"/>
                                        </label>
                                    </span>
                                </div>
...
<div class="modal fade" id="iconPickerModalV2" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('messages.vcard.select_icon') }}</h5>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div id="iconPickerV2"
                            ...
                            data-icon="{{ isset($vcard) && $vcard->dob_icon ? $vcard->dob_icon : 'fa-solid fa-icons' }}"
                            role="iconpicker"></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer pt-0 px-3 pb-3">
