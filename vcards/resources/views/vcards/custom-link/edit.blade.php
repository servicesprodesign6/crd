            ...
            <div class="modal-body">
                <div class="row mb-5">
                    ...
                    <div class="col-6">
                        ...
                        @endphp
                        {{ Form::select('button_type', $customLinksBtn, isset($customLink['button_type']) ? $customLink['button_type'] : null, ['class' => 'form-control form-select', 'data-control' => 'select2', 'id' => 'editButtonType', 'wire:ignore', 'data-dropdown-parent' => '#editCustomLinkModal']) }}
                    </div>
