                ...
                <div class="image-picker">
                    <div class="image previewImage" id="featuresInputImage"
                         ...
                         <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                               data-placement="top" data-bs-original-title="{{__('messages.tooltip.change_feature_image')}}">
                    <label>
                        <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                        <input type="file" id="profile_image" name="featureImage" class="image-upload file-validation d-none crop-image-input"
                               accept="image/*" data-crop-width="78" data-crop-height="78" data-preview-id="featureImagePreview"/>
                    </label>
                </span>
                </div>
            </div>
