@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/organisation*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/organisation*') ? 'active' : '' }}"
            href="{{ route('organisation.index') }}">{{ __('messages.organization.organizations') }}</a>
    </li>

    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/add-on*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/add-on*') ? 'active' : '' }}"
            href="{{ route('addon.index') }}">{{ __('messages.addon.addon') }}</a>
    </li>
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/custom-page*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/custom-page*') ? 'active' : '' }}"
            href="{{ route('custom.page.index') }}">{{ __('messages.custom_page.custom_page') }}</a>
    </li>
...
@role(App\Models\Role::ROLE_ADMIN)
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/organisation/users*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('admin/organisation/users*') ? 'active' : '' }}"
            href="{{ route('organisation.users.index') }}">{{ __('messages.users') }}</a>
    </li>
