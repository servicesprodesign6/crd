...
<div>
    <div class="dropdown d-flex align-items-center me-4 me-md-5" wire:ignore>
        <button class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0" type="button"
            id="dropdownMenuUserStatus" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
...
<div>
    <a type="button" class="btn btn-primary ms-auto" href="{{ route('organisation.create') }}">{{ __('messages.organization.add_organization') }}</a>
</div>
