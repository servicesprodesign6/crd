<div class="row">
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('organisation_name', __('messages.organization.organization_name') . ':', ['class' => 'form-label required']) }}
            {{ Form::text('organisation_name', isset($user) ? $user->organisation_name : null, ['class' => 'form-control', 'placeholder' => __('messages.organization.organization_name'), 'required']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
                        ...
                        <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                            ...
                            <label>
                                ...
                                <input type="file" id="profile_image" name="profile"
                                    ...
                                    data-crop-width="100" data-crop-height="100"
                                    data-preview-id="userProfileImagePreview" />
                            </label>
                        </span>
                    </div>
    ...
    <div>
        {{ Form::hidden('is_organisation', 1) }}
        {{ Form::submit(__('messages.common.save'), ['class' => 'btn btn-primary me-3']) }}
        <a href="{{ route('organisation.index') }}" class="btn btn-secondary">{{ __('messages.common.discard') }}</a>
    </div>
</div>
