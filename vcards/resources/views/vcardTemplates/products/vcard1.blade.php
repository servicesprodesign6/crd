    ...
    <div class="container p-0 h-100">
        <div class="vcard-one main-content w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="row justify-content-between align-items-center mb-6 mx-0" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                    <div class="col-4 px-2">
                        <h4 class="vcard-one-heading text-start">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 px-2">
                        ...
                        @foreach ($products as $product)
                            <div class="mb-5 mt-1 text-center">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card px-2 border-0 w-sm-100 h-100 mx-auto">
                                        <div
                                        ...
                                        <div class="mt-3">
                                            ...
                                            @if ($product->currency_id && $product->price)
                                                <span
                                                    class="text-black fs-4 product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                            @elseif($product->price)
                                                <span
                                                    class="text-black fs-4 product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                            @endif
                                </a>
