                        ...
                        <div class="px-30">
                            <div class="product-card card">
                                ...
                                <div class="card-body card-padding p-0">
                                    <div class="product-desc" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        ...
                                        <div class="product-amount text-primary fw-bold fs-18">
                                            @if ($product->currency_id && $product->price)
                                                <span
                                                    class="fs-18 fw-6 product-price product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                            @elseif($product->price)
                                                <span
                                                    class="fs-18 fw-6 product-price product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                            ...
                                            @if ($product->product_url)
                                                <div class="ms-1 mt-3">
                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        class="btn btn-primary btn-product-enquiry text-white @if(!$product->product_url) disabled @endif">
