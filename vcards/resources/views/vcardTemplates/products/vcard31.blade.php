                        ...
                        <div class="px-2">
                            <div class="product-card card mb-6 overflow-hidden">
                                                ...
                                                <div>
                                                    <div class="product-img-height text-center mx-auto">
                                                        <img src="{{ $media->getUrl() }}" alt="{{ $product->name }}"
                                                            class="text-center w-100 object-fit-contain" height="208px"
                                                            loading="lazy">
                                                    </div>
                                                </div>
                                            @endforeach
                                ...
                                <div class="card-body p-4 text-center">
                                    <div class="product-desc mb-2" @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <h3 class="text-white fs-20 fw-5 mb-0 me-2">{{ $product->name }}</h3>
                                    </div>
