    ...
    <div class="container p-0">
        <div class="vcard-twentyfive main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0">
                <div class="d-flex justify-content-between align-items-center mb-4 px-4 gap-3"
                    ...
                    <div>
                        <a class="back-btn text-decoration-none  text-light" href="{{ $vcardUrl }}"
                            ...
                            <div class="product-card card card-margin p-0 mb-3 border-primary">
                                ...
                                <div class=" card-body">
                                    <div class="text-center d-flex flex-column gap-2">
                                        <h3 class="text-primary fs-18 fw-5 mb-0">{{ $product->name }}</h3>
                                        <p class="fs-14 text-dark mb-0 pb-0">{{ $product->description }}</p>
