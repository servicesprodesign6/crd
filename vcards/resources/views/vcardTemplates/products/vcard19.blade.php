        ...
        <div class="vcard-nineteen bg-white main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 px-30 mt-0">
                <div class="d-flex justify-content-between align-items-center mb-4"
                    ...
                    <div>
                        <a class="product-btn d-block text-decoration-none" href="{{ $vcardUrl }}"
                            ...
                            <div class="mb-4">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card text-start border-0 w-sm-100 h-100 mx-auto">
                                        <div
                                            class="mb-0 {{ $product->media->count() < 2 ? 'd-flex justify-content-center' : '' }} product-img-slider overflow-hidden">
                                        ...
                                        <div>
                                            <div
                                                class="d-flex justify-content-between py-2 align-items-center justify-content-center flex-column text-center gap-3">
                                                <div>
