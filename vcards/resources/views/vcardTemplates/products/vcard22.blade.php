            ...
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="d-flex align-items-center gap-2 mb-4 justify-content-between"
                    ...
                    <div class="text-center">
                        <a class="back-btn text-decoration-none d-block" id="product-back" href="{{ $vcardUrl }}"
                                ...
                                <div class="card-body card-padding px-0 pb-0">
                                    ...
                                    <div class="product-amount text-primary fw-bold fs-20 mb-3">
                                        @if ($product->currency_id && $product->price)
                                            <span
                                                class="fs-20 fw-6 product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, $product->currency->currency_code) }}</span>
                                        @elseif($product->price)
                                            <span
                                                class="fs-20 fw-6  product-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                        @endif
                                    </div>
