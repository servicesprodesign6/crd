    ...
    <div class="container p-0">
        <div class="vcard-twelve main-content  w-100 mx-auto content-blur allSection collapse show">
            <div class="vcard-one__product py-3 mt-0">
                <div class="d-flex align-items-center gap-3 justify-content-between mb-4 px-30"
                    ...
                    <div>
                        <a class="btn btn-primary text-decoration-none" href="{{ $vcardUrl }}"
                                            ...
                                            @if ($product->product_url)
                                                <div class="ms-1 mt-3">
                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        class="btn product-btn btn-primary text-decoration-none btn-product-enquiry @if(!$product->product_url) disabled @endif">
