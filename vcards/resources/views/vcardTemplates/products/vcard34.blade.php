                    ...
                    @foreach ($vcard->products as $product)
                        <div>
                            <div class="product-card card mb-7 bg-transparent">
                                ...
                                <div class="card-body">
                                    <div class="product-desc d-flex justify-content-between align-items-center mb-2 text-center"
                                        @if (getLanguage($vcard->default_language) == 'Arabic' || getLanguage($vcard->default_language) == 'Persian') dir="rtl" @endif>
                                        <h3 class="text-white fs-18 fw-5 mb-0 me-2">{{ $product->name }}</h3>
                                    </div>
                                    <p class="fs-14 text-gray-200 mb-2 text-center">{{ $product->description }}</p>
                                     <div class="product-amount fw-bold fs-18 text-center mb-4">
