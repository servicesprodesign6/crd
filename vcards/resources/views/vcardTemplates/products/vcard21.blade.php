            ...
            <div class="vcard-one__product py-3 mt-0 px-30">
                <div class="d-flex align-items-center gap-2 mb-4 justify-content-between"
                    ...
                    <div class="text-center">
                        <a class="text-decoration-none btn-gradient d-block btn px-4" href="{{ $vcardUrl }}"
                                    ...
                                    <div class="px-4 py-0 card-body text-center">
                                        ...
                                        <div class="product-amount text-primary fw-bold fs-20 mb-3">
                                            ...
                                            @elseif($product->price)
                                                <span
                                                    class="fs-18 fw-6 text-primaryproduct-price-{{ $product->id }}">{{ currencyFormat($product->price, 2, getUserCurrencyIcon($vcard->user->id)) }}</span>
                                            @endif
                                        </div>
                                            ...
                                            @if ($product->product_url)
                                                <div class="ms-1">
                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        class="btn btn-gradient btn-product-enquiry @if(!$product->product_url) disabled @endif">
