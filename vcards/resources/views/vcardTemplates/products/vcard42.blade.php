...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('assets/css/vcard42.css') }}">
    {{-- google font --}}
                            ...
                            <div class="product-card card mb-5">
                                ...
                                <div class="card-body p-3">
                                    <div class="product-desc">
                                        <h3 class="text-black fs-20 fw-semibold mb-2">{{ $product->name }}</h3>
                                    </div>
                                    <p class="fs-14 text-secondary mb-2">{{ $product->description }}</p>
                                    <div class="product-amount fs-20 mb-3 text-secondary" style="font-weight: 500">
                                            ...
                                            @if ($product->product_url)
                                                <div class="ms-1">
                                                    <a href="{{ $product->product_url ?? 'javascript:void(0)' }}"
                                                        ...
                                                        class="btn btn-product-enquiry fs-16 @if (!$product->product_url) disabled @endif">
