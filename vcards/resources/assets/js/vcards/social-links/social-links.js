...
let socialLinkCounter = Date.now();

listenClick(".social-links", function () {
    var title = Lang.get("js.delete");

    const uniqueId = socialLinkCounter++;
    const previewId = `socialLinkPreview${uniqueId}`;
    const inputId = `profile_image${uniqueId}`;
    ...
    $(".social-links-add").append(
        ...
        '                                                <div class="image previewImage " id="${previewId}"\n' +
        ...
        "                                                    <label>\n" +
        '                                                    <i class="fa-solid fa-pen" id="profileImageIcon${uniqueId}" ></i>\n' +
        '                                                        <input type="file" id="${inputId}" name="social_links_image[]"\n' +
        '                                                               class="image-upload d-none social_links_image crop-image-input" accept="image/*" data-preview-id="${previewId}""/>\n' +
        "                                                    </label>\n" +
        "                                                </span>\n" +
        "                                            </div>\n" +
        "                                        </div>\n" +
