...
listenClick(".subscribed-user-plan-view-btn", function (event) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            let tenantOrganisationUser = result.data.tenant.organisation_user;
            let tenantUser = result.data.tenant.user;
            let subscriptionUserName = tenantOrganisationUser
                ? (tenantOrganisationUser.organisation_name || tenantOrganisationUser.full_name)
                : (tenantUser ? tenantUser.full_name : "");

            $("#subscriptionUserName").text(subscriptionUserName);
