document.addEventListener("DOMContentLoaded", function () {
    const no_of_whatsapp_store = document.getElementById('whatsappStore');
    const no_of_whatsapp_store_input = document.querySelector('input[name="no_of_whatsapp_store"]');

    const no_of_visitors = document.getElementById('noOfVisitors');
    const no_of_visitors_input = document.querySelector('input[name="no_of_visitors"]');
    const organization_users = document.getElementById('organizationUsers');
    const organization_users_input = document.querySelector('input[name="no_of_organization_users"]');

    if (no_of_whatsapp_store && no_of_whatsapp_store_input) {
        if (getComputedStyle(no_of_whatsapp_store).display === 'none') {
            no_of_whatsapp_store_input.removeAttribute('required');
        } else {
            no_of_whatsapp_store_input.setAttribute('required', 'required');
        }
    }

    if (no_of_visitors && no_of_visitors_input) {
        if (getComputedStyle(no_of_visitors).display === 'none') {
            no_of_visitors_input.removeAttribute('required');
        } else {
            no_of_visitors_input.setAttribute('required', 'required');
        }
    }

    if (organization_users && organization_users_input) {
        if (getComputedStyle(organization_users).display === 'none') {
            organization_users_input.removeAttribute('required');
        } else {
            organization_users_input.setAttribute('required', 'required');
        }
    }
