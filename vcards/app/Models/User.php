...
class User extends Authenticatable implements HasMedia, MustVerifyEmail
{
    ...
    public function organisationUserPermission(): HasOne
    {
        return $this->hasOne(OrganisationUserPermission::class, 'user_id');
    }

    public function assignedVcards(): BelongsToMany
    {
        return $this->belongsToMany(Vcard::class, 'vcard_user');
    }

    public function assignedWhatsappStores(): BelongsToMany
    {
        return $this->belongsToMany(WhatsappStore::class, 'whatsapp_store_user');
    }

    public function canCreateVcards(): bool
    {
        if (empty($this->organisation_id)) {
            return true;
        }

        return (bool) optional($this->organisationUserPermission)->can_create_vcard;
    }

    public function canEditVcards(): bool
    {
        if (empty($this->organisation_id)) {
            return true;
        }

        return (bool) optional($this->organisationUserPermission)->can_edit_vcard;
    }

    public function canCreateWhatsappStore(): bool
    {
        if (empty($this->organisation_id)) {
            return true;
        }

        return (bool) optional($this->organisationUserPermission)->can_create_whatsapp_store;
    }

    public function canEditWhatsappStore(): bool
    {
        if (empty($this->organisation_id)) {
            return true;
        }

        return (bool) optional($this->organisationUserPermission)->can_edit_whatsapp_store;
    }
