...
class WpStoreTemplatesProductsList extends Component
{
    ...
    public function render()
    {
        ...
        $perPage = ($template === 'travel') ? 5 : 9;

        $products = WhatsappStoreProduct::with(['category', 'currency'])->where('whatsapp_store_id', $this->whatsappStoreId)
        ...
        $categories = ProductCategory::where('whatsapp_store_id', $this->whatsappStoreId)
