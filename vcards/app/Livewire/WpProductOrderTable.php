...
class WpProductOrderTable extends LivewireTableComponent
{
    ...
    protected $listeners = ['refresh' => '$refresh', 'changeFilterStatus', 'changeFilterOrderType'];
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.whatsapp_stores.order_type'), "order_type")
                ->view('whatsapp_stores.product_orders.columns.order_type')
                ->sortable(),
    ...
    public function builder(): Builder
    {
        ...
        $wpOrders->when($orderType !== null && $orderType !== '', function ($q) use ($orderType) {
    ...
    public function changeFilterOrderType($orderType)
    {
