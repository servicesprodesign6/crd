    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.vcard.user_name'), 'tenant.tenant_username')->sortable(function (
                ...
                ->searchable(),
            Column::make(__('messages.vcard.vcard_preview_url'), 'url_alias')
                ->hideIf('url_alias')
                ->searchable(),
            Column::make(__('messages.vcard.vcard_preview_url'), 'url_alias')->sortable()->view('sadmin.vcards.columns.preview'),
            ...
            // Column::make(__('messages.vcard.clone_to'), 'id')
            //     ->view('sadmin.vcards.columns.clone-to'),
            Column::make(__('messages.common.action'), 'id')
                ->view('sadmin.vcards.columns.action'),
        ];
    }
