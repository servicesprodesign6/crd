...
class PlanRepository extends BaseRepository
{
    ...
    public function store($input)
    {
        try {
            ...
            $inputFields = ['name','currency_id','price','frequency','is_default','trial_days','no_of_vcards','no_of_organization_users','storage_limit','status', 'custom_select','no_of_whatsapp_store', 'no_of_visitors'];
    ...
    public function update($input, $id)
    {
        ...
        try {
         ...
         if ($input['custom_select'] == 1) {
            ...
            $input['linkedin_embed'] = isset($input['linkedin_embed']) ? 1 : 0;
            $input['visitors'] = isset($input['visitors']) ? 1 : 0;
            $input['organization_users'] = isset($input['organization_users']) ? 1 : 0;
